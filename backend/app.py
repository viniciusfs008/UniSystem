...
openai.api_key = "sk-Y5xVrH0Zt27Y3-uromQO65LrxfGPywRVVNxJvNERxVT3BlbkFJgnTJtVGMTfXFvPfWTypxsfsCBa0Iop7BZek1Cqa3MA"
...
def dashboard(tipo):
    if tipo == "almoxarifado":
        ...
        data = pd.read_csv("dados/Dispesas.csv")
        data = data.where(pd.notnull(data), "N/A")
        # insights = generate_insights(data)
    elif tipo == "rh":
